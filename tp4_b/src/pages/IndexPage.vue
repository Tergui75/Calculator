...
q-page(padding)
  ...
  .row.justify-center(v-if="isSignedIn")  
    q-btn(color="orange-5" rounded @click="states.addCounter()", data-cy="btn-add-new-operand",).q-mb-md Add a New Operand
    q-btn(color="green-5" rounded @click="pullfromServer", data-cy="btn-pull",).q-mb-md Pull Shared operand
  .row.justify-center
